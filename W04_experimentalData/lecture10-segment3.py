...
"""
Bills and returns multiple models.
degrees = list or tuple of degrees. x(y)Vals are the values from the data
Returns a list of models, one for each degree.
"""
...
"""
Tests the models from genFits.
Use of pylab.polyval() allows us to use the same code to test
