...
# draws a vertical red line (axV, color = r)
...
def showErrorBars(population, sizes, numTrials):
    ...
    # makes error bars. first two value are x and y values
    # yerr = y error, error bars parallel to y axis with size 1.96 times std's
    # fmt = format, we put in 'o's    
