...
"""
This section of code will plot the standard error of the mean (SEM) vs.
the std of 50 means (numTrials). You will see the SEM tracks the sample
std quite closely.
"""    
...
def plotDistributions():
    ...
    for i in range(100000):
        uniform.append(random.random()) # makes uniformly distributed histogram
        normal.append(random.gauss(0, 1)) # makes normally distributed hist
        exp.append(random.expovariate(0.5)) # makes an exonential hist, heavily skewed left
...
#plotDistributions()
"""
Compares the standard deviation of the population vs. a sample of the population.
Does this comparis for uniform, normal, and exponential data sets.
